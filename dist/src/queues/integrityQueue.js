...
exports.integrityWorker = exports.integrityQueue = void 0;
exports.scheduleIntegrityCheck = scheduleIntegrityCheck;
const bullmq_1 = require("bullmq");
const redis_1 = require("../utils/redis");
const db_1 = require("../utils/db");
const DiscordProvider_1 = require("../storage/DiscordProvider");
const crypto_1 = __importDefault(require("crypto"));
exports.integrityQueue = new bullmq_1.Queue('integrityCheck', {
    connection: redis_1.redisConnection,
});
// A shared discord provider just for the worker
const discordProvider = new DiscordProvider_1.DiscordProvider('discord-worker', process.env.DISCORD_BOT_TOKEN || '', process.env.DISCORD_CHANNEL_ID || '');
exports.integrityWorker = new bullmq_1.Worker('integrityCheck', async (job) => {
    ...
    const replication = await db_1.prisma.replication.findFirst({
        where: {
            status: 'READY',
    ...
    try {
        ...
        if (hash === replication.chunk.hash) {
            // Success
            await db_1.prisma.replication.update({
...
async function scheduleIntegrityCheck() {
    await exports.integrityQueue.add('verify-chunk', {}, {
        removeOnComplete: true,
        removeOnFail: 100 // Keep last 100 failed jobs
    });
}
//# sourceMappingURL=integrityQueue.js.map